...
export default function FanProducts() {
  ...
  const FanProducts = products.filter((product) => product.category === "Fan");
  const filteredProducts = FanProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Fans.</h1>
