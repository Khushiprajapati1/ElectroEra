...
export default function BlenderProducts() {
  ...
  const BlenderProducts = products.filter((product) => product.category === "Blender");
  const filteredProducts = BlenderProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Blenders.</h1>
        ...
        {filteredProducts.map((product) => {
          ...
          return (
            ...
            >
              ...
              <button className="mt-4 w-full flex items-center gap-2 justify-center cursor-pointer bg-gradient-to-r from-fuchsia-500 to-pink-500 text-white font-bold py-2 rounded transition-transform transform hover:scale-103"
