...
export default function HaierWMProducts() {
  ...
  const HaierWM = products.filter((product) => product.category === "WM" && product.brand === "Haier");
  const filteredProducts = HaierWM.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Haier Washing Machines.</h1>
