...
export default function GeyserProducts() {
  ...
  const GeyserProducts = products.filter((product) => product.category === "Geyser");
  const filteredProducts = GeyserProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Geysers.</h1>
