...
export default function GrillerProducts() {
  ...
  const GrillerProducts = products.filter((product) => product.category === "Griller");
  const filteredProducts = GrillerProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Griller / Sandwich Maker.</h1>
