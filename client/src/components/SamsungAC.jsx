...
export default function SamsungAC() {
  ...
  const { wishlist, toggleWishlist } = useWishlist();
     ...
     const samsungProducts = products.filter((product) => product.brand === "Samsung" && product.category === "AC");
     const filteredProducts = samsungProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Samsung Air Conditioners</h1>
