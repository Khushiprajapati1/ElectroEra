...
export default function LlyodAC() {
 ...
 const { wishlist, toggleWishlist } = useWishlist();
   ...
   const llyodProducts = products.filter((product) => product.brand === "Llyod" && product.category === "AC");
   const filteredProducts = llyodProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Llyod Air Conditioners</h1>
