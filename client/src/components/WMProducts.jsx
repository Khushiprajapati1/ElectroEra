...
export default function WMProducts() {
  ...
  const WMProducts = products.filter((product) => product.category === "WM");
  const filteredProducts = WMProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Washing Machines.</h1>
