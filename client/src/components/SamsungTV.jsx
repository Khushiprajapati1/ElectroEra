...
export default function SamsungTVProductsPage() {
  ...
  const SamsungTV = products.filter((product) => product.category === "TV" && product.brand === "Samsung");
  const filteredProducts = SamsungTV.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Samsung Televisions.</h1>
