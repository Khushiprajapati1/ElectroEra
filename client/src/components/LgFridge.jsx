...
export default function LgFridgeProducts() {
  ...
  const LgFridge = products.filter((product) => product.category === "Fridge" && product.brand === "LG");
  const filteredProducts = LgFridge.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">LG Refrigerators.</h1>
