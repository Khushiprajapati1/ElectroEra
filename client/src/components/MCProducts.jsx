...
export default function MCProducts() {
  ...
  const MCProducts = products.filter((product) => product.category === "Microwave");
  const filteredProducts = MCProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Microwaves.</h1>
