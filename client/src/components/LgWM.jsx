...
export default function LGWMProducts() {
  ...
  const LgWM = products.filter((product) => product.category === "WM" && product.brand === "LG");
  const filteredProducts = LgWM.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">LG Washing Machines.</h1>
