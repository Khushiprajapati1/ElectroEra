...
export default function JuicerProducts() {
  ...
  const JuicerProducts = products.filter((product) => product.category === "Juicer");
  const filteredProducts = JuicerProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Juicers.</h1>
