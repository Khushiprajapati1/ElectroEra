...
export default function HaierFridgeProducts() {
  ...
  const HaierFridge = products.filter((product) => product.category === "Fridge" && product.brand === "Haier");
  const filteredProducts = HaierFridge.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Haier Refrigerators.</h1>
