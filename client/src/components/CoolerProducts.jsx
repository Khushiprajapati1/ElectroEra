...
export default function CoolerProducts() {
  ...
  const CoolerProducts = products.filter((product) => product.category === "Cooler");
  const filteredProducts = CoolerProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Coolers.</h1>
