...
export default function SamsungFridgeProducts() {
  ...
  const SamsungFridge = products.filter((product) => product.category === "Fridge" && product.brand === "Samsung");
  const filteredProducts = SamsungFridge.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Samsung Refrigerators.</h1>
