...
export default function OvenProducts() {
  ...
  const OvenProducts = products.filter((product) => product.category === "Oven");
  const filteredProducts = OvenProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Oven Toaster Grillers.</h1>
