...
export default function LgAC() {
  ...
  const lgProducts = products.filter((product) => product.brand === "LG" && product.category === "AC");
  const filteredProducts = lgProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">LG Air Conditioners</h1>
