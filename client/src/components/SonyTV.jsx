...
export default function SonyTVProductsPage() {
  ...
  const SonyTV = products.filter((product) => product.category === "TV" && product.brand === "Sony");
  const filteredProducts = SonyTV.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Sony Televisions.</h1>
