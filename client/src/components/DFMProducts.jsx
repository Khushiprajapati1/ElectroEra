...
export default function DFMProducts() {
  ...
  const DFMProducts = products.filter((product) => product.category === "DFM");
  const filteredProducts = DFMProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Domestic Flour Mills / Atta Chakki.</h1>
