...
export default function HaierAC() {
  ...
  const haierProducts = products.filter((product) =>
    product.brand === "Haier" && product.category === "AC"
  );
  const filteredProducts = haierProducts.filter((product) =>
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">Haier Air Conditioners</h1>
