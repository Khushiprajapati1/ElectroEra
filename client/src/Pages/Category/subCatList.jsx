  ...
  return (
    <>
      <div className="flex items-center justify-between px-2 py-0 mt-3">
        <h2 className="text-[18px] font-bold font[600]">Sub Category List</h2>
        ...
        <div className="relative overflow-x-auto mt-5 pb-5">
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                <th scope="col" className="px-1 pr-0 py-3">
            ...
            <tbody>
              <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td className="px-0 py-2" width={200}>
                ...
                <td scope="col" className="px-6 py-2">
                  <div className="flex items-center gap-3">
                    <Chip label="Haier" color="primary" />
                    <Chip label="Samsung" color="primary" />
                    <Chip label="Sony" color="primary" />
                  </div>
                </td>

                <td scope="col" width={200} className="px-6 py-2">
